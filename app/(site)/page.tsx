  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="p-10 max-w-6xl">
        ...
        WE BUILD <span className="bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 bg-clip-text text-transparent">2 BRANDS</span> THAT CONNECT YOUR IDEAS TO THE WORLD
