...
export default async function Project({ params }: Props){
    ...
    <div>
        <header className="flex justify-between items-center">
            ...
            <a href="{project.url}" title="View Project" target="_blank" rel="noopener noreferrer classnam
            bg-gray-100 rounded-lg text-gray-500 font-bold py-3 px-4 whitespace-nowrap hover:bg-pink-500 hover:text-pink-100 transition">
                View Project
            </a>
